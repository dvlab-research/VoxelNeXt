...
if __name__ == '__main__':
    ...
    root = "/data/datasets/argo2/sensor" #'/mnt/weka/scratch/lve.fan/data/lidar/argoverse2/sensor'
    output_dir = "/data/datasets/argo2/processed" #'/mnt/weka/scratch/lve.fan/FSD/data/argo2/kitti_format'
    save_bin = True
